...
/*
 * Continue refresh page even the WPSState is '4 (WPS_ERROR)'
 * because it is possible to get '2 WPS_SUCCESS' after Client try with other AP
 */
if((WPSState == '0 (WPS_INITAL)') || (WPSState == '1 (WPS_START)') || (WPSState == '4 (WPS_ERROR)') || (WPSState == '8 (WPS_PROCESS)'))
{
