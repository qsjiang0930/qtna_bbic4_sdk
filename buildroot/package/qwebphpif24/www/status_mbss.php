...
if(!(strpos($ssid8, "QCS API error") === FALSE))
{$ssid8="N/A";}
//============================================
?>
	...
	<div class="right">
		...
		<div class="rightmain">
			<table class="tablemain">
				...
				<tr <?php if($ssid1 == "N/A" || $curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>
					<td>MBSS 1: </td>
				...
				<tr <?php if($ssid2 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 2: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 1: </td>
				...
				<tr <?php if($ssid3 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 3: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 2: </td>
				...
				<tr <?php if($ssid4 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 4: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 3: </td>
				...
				<tr <?php if($ssid5 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 5: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 4: </td>
				...
				<tr <?php if($ssid6 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 6: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 5: </td>
				...
				<tr <?php if($ssid7 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 7: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 6: </td>
				...
				<tr <?php if($ssid8 == "N/A") echo "style=\"display: none;\""; ?>>
					<td <?php if($curr_mode == "Repeater") echo "style=\"display: none;\""; ?>>MBSS 8: </td>
					<td <?php if($curr_mode != "Repeater") echo "style=\"display: none;\""; ?>>MBSS 7: </td>
