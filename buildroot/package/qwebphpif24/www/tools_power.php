		...
		<div class="rightmain">
			<table class="tablemain">
				<tr>
					...
					<td width="60%">
					<input type="radio" name="pwr_cal_wifi0" value="on"  <?php if($curr_pwr_cal == "on") echo "checked=\"checked\""; ?> onclick="modechange(this);"/> On &nbsp; &nbsp;
