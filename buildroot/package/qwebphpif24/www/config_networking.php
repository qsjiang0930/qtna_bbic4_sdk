...
function load_value()
{
	global $curr_ipaddr,$curr_mask,$old_static,$static,$dhcp_exit;
...
function set_value()
{
	...
	{
		$new_addr = htmlspecialchars($_POST['ipaddress']);
		$new_mask = htmlspecialchars($_POST['netmask']);
...
<div class="container">
	...
	<div class="right">
		<div class="righttop">SYSTEM - NETWORKING</div>
		<div class="rightmain">
			<table class="tablemain">
				...
				<tr>
					<td>BSSID:</td>
					<td><input name="txt_bssid" type="text" id="txt_bssid" value="<?php if($curr_mode == "Repeater") $interface = "wifi1";else $interface = "wifi0"; $tmp=exec("call_qcsapi get_bssid $interface");echo $tmp;?>" class="textbox" disabled="disabled"/></td>
				</tr>
				<tr>
