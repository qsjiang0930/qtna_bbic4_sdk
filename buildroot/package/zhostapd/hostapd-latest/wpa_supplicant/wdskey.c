...
static int
wpa_driver_madwifi_wds_set_key(void *priv, int alg,
...
int main(int argc, char *argv[])
{
	...
	pbkdf2_sha1(passphrase, (u8 *)ssid, strlen(ssid), 4096, psk, 32);
	...
	ret = wpa_driver_madwifi_wds_set_key(drv, WPA_ALG_CCMP,
			peeraddr, 0, 1,
			NULL, 0, psk, 32);
