...
#ifdef CONFIG_QTNA_WIFI
	/* psk_md5 - WPA pre-shared key for md5 (256 bits)
	 */
	u8 psk_md5[32];
#endif /* CONFIG_QTNA_WIFI */
...
#ifdef CONFIG_QTNA_WIFI
#define NETWORK_DEFAULT_FLAGS		0
#define NETWORK_ACCESS_THRU_WPS		BIT(0)
	/**
	 * flags - additional flags for the network
	 */
	int flags;

	/**
	 * from_wps - the ssid is got from WPS
	 */
	int from_wps;
#endif /* CONFIG_QTNA_WIFI */
