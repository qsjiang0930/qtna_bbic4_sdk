...
#define DEFAULT_SPECIFIC_SCAN 1
#define DEFAULT_MAX_SCAN_RESULT_BUF 65535
#ifdef CONFIG_WPS
#define DEFAULT_WPS_STATE 1
#endif /* CONFIG_WPS */
...
#define CFG_CHANGED_EASYMESH_BACKHAUL_STA_PROFILE BIT(20)

#define MAP_BACKHAUL_STA_MIN	0
#define MAP_BACKHAUL_STA_MAX	0x1
enum {
	MAP_BACKHAUL_STA_PROFILE_MIN = 1,
	MAP_BACKHAUL_STA_PROFILE_1 = MAP_BACKHAUL_STA_PROFILE_MIN,
	MAP_BACKHAUL_STA_PROFILE_2 = 2,
	MAP_BACKHAUL_STA_PROFILE_MAX = MAP_BACKHAUL_STA_PROFILE_2,
} map_backhaul_sta_profile_type;
#define DEFAULT_MAP_BACKHAUL_STA_PROFILE MAP_BACKHAUL_STA_PROFILE_MIN
#endif /* CONFIG_QTNA_WIFI */
...
#define MAX_SEC_DEVICE_TYPES 5
	...
	int easymesh_backhaul_sta_profile;
#endif /* CONFIG_QTNA_WIFI */
...
#ifdef CONFIG_QTNA_WIFI
	/**
	 * specific_scan - Specific SSID scan
	 *
	 * 1: Just perform specific SSID scan

	 * 0: Perform wildcard SSID scan
	 */
	int specific_scan;

	/**
	 * scan_buf_max_size - Max scan results buffer size
	 */

	int scan_buf_max_size;
	/**
	* wps_state - Enabled (1) or Disabled (0)
	*/
	int wps_state;
	/*
	 * pairing_id - Pairing ID.
	 *
	 * This is used for pairing protection between AP and STA.
	 */
	u8 *pairing_id;
...
#define PPS2_MODE_DENY 2
	/*
	 * pairing_enable - pps2 option value(0->disable, 1->whitelist and 2->blacklist)
	 *
	 * This is used for disabling and setting whitelist and blacklist mode.
	 */
	unsigned int pairing_enable;

	/*
	 * quantenna add for allowing PBC overlap
	 * 0 = don't allow pbc overlap as spec says
	 * 1 = allow pbc overlap occurs
	 */
	int wps_allow_pbc_overlap;

	/*
	 * easymesh_backhaul_prefer_ssid - preferred SSID.
	 *
	 * The BSS including the preferred SSID is the sole backhaul BSS for bSta association.
	 */
	u8 *easymesh_backhaul_prefer_ssid;

	/*
	 * easymesh_backhaul_prefer_ssid_len - preferred SSID length.
	 */
	int easymesh_backhaul_prefer_ssid_len;
#endif /* CONFIG_QTNA_WIFI*/
};
