...
#define WPA_QTN_MAX_RBS_NUM		8
/* Extender Role IE */
struct wpa_qtn_ext_bssid {
	u8 id;			/* IEEE80211_ELEMID_VENDOR */
	u8 len;			/* 59 */
	u8 qtn_ie_oui[3];	/* QTN_OUI - 0x00, 0x26, 0x86*/
	u8 qtn_ie_type;		/* QTN_OUI_EXTENDER_BSSID */
	u8 mbs_bssid[ETH_ALEN]; /* BSSID of mbs */
	u8 rbs_num;
	u8 rbs_bssid[WPA_QTN_MAX_RBS_NUM][ETH_ALEN]; /* BSSID of rbs */
} STRUCT_PACKED;
#endif /* CONFIG_QTNA_WIFI */
