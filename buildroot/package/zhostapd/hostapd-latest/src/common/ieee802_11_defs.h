...
#define MAP_IE_VENDOR_TYPE 0x506f9a1b
#define MAP_OUI_TYPE 27
#define MAP_OUI_IE_MIN_LEN 7
...
/* FIXME:  Making this change for compilation */
...
#ifdef CONFIG_QTNA_WIFI
/* WFA Multi-AP Extension subelement Defines */
#define MAP_EXT_SUBELE_ID		0x06
#define MAP_EXT_SUBELE_ID_LEN		0x01

#define MAP_EXT_SUBELE_TEAR_DOWN	BIT(4)
#define MAP_EXT_SUBELE_FRONTHAUL_BSS	BIT(5)
#define MAP_EXT_SUBELE_BACKHAUL_BSS	BIT(6)
#define MAP_EXT_SUBELE_BACKHAUL_STA	BIT(7)

#define MAP_PROFILE_SUBELE_ID		0x07
#define MAP_PROFILE_SUBELE_ID_LEN	0x01
#define MAP_EXT_IELEN_MAX		24
#endif /* CONFIG_QTNA_WIFI */
