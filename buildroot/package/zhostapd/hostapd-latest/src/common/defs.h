...
/* Maximum length of message posted to the driver for logging */
#define MAX_WLAN_MSG_LEN 256
#define UUID_HEX_STR_LEN    41
...
#ifdef CONFIG_QTNA_WIFI
/**
 * enum wps_lockdown - AP PIN lockdown methods
 */
enum wps_lockdown {
	WPS_LOCKDOWN_DEFAULT = 0,
	WPS_LOCKDOWN_AUTO,
};
#endif /* CONFIG_QTNA_WIFI */
