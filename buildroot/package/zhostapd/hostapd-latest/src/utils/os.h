...
/**
 * os_strnlen - Find the length of a length-limited string
 * @s: The string to be sized
 * @count: The maximum number of bytes to search
 */
size_t os_strnlen(const char *s, size_t count);
...
#ifdef CONFIG_QTNA_WIFI
#define strnlen OS_DO_NOT_USE_strnlen
#endif /* CONFIG_QTNA_WIFI */
