...
enum {
	...
	WFA_ELEM_MULTIAP_BACKHAUL_EXTENSION = 0x06,
#endif /* CONFIG_QTNA_WIFI */
};

#ifdef CONFIG_QTNA_WIFI
/*  Multi-AP extension subelement value */
#define MULTIAP_BACKHAUL_TEAR_DOWN	0x10
#define MULTIAP_FRONTHAUL_BSS	0x20
#define MULTIAP_BACKHAUL_BSS	0x40
#define MULTIAP_BACKHAUL_STA	0x80
#endif /* CONFIG_QTNA_WIFI */
...
#ifdef CONFIG_QTNA_WIFI
#define WPS_ENCR_AES_TKIP (WPS_ENCR_TKIP | WPS_ENCR_AES)
#endif /* CONFIG_QTNA_WIFI */
...
#ifdef CONFIG_QTNA_WIFI
enum wps_external_state {
	WPS_EXT_STATE_INI = 0,
	WPS_EXT_STATE_PROCESS_START = 1,
	WPS_EXT_STATE_PROCESS_SUCCESS = 2,
	WPS_EXT_STATE_MSG_EX_ERROR = 3,
	WPS_EXT_STATE_TIMEOUT_ERROR = 4,
	WPS_EXT_STATE_MSG_EX_OVERLAP = 5,
	WPS_EXT_STATE_EAP_M2_SEND = 6,
	WPS_EXT_STATE_EAP_M8_SEND = 7,
	WPS_EXT_STATE_STA_CANCEL = 8,
	WPS_EXT_STATE_STA_PIN_FAIL = 9,
	WPS_EXT_STATE_AP_PIN_SUCCESS = 10,
	WPS_EXT_STATE_AP_PIN_FAIL = 11,
	WPS_EXT_STATE_PIN_TIMEOUT = 12,
	WPS_EXT_STATE_UNKNOWN = -1
};
#endif /* CONFIG_QTNA_WIFI */
...
#ifdef CONFIG_QTNA_WIFI
/* WPS Fast Reassociation State */
enum wps_reassoc_state {
	WPS_REASSOC_DEFAULT,
	WPS_REASSOC_WPS_ENABLED,
};
#endif /* CONFIG_QTNA_WIFI */
...
extern int qtn_wps_pbc_timeout;

#define WPS_PIN_DEFAULT_TIMEOUT		120
#define WPS_AP_PIN_DEFAULT_TIMEOUT	900
#define WPS_AP_PIN_LEN			8

/* Quantenna add for allowing PBC overlap */
#define WPS_ALLOW_PBC_OVERLAP		1
#define WPS_FORBID_PBC_OVERLAP		0

#define WPS_QUANTENNA_EXT_ATTR_SIZE	6
#define WPS_VENDOR_ID_QTN		9862	/* 002686 */
#define WPS_ALLOW_PBC_VL_SUB_ID		00
#endif /* CONFIG_QTNA_WIFI */
