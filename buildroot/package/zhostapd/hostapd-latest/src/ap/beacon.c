...
#define BEACON_TAIL_BUF_SIZE 512
	...
	*pos++ = WLAN_EID_SSID;
...
#ifdef CONFIG_HS20
#ifdef CONFIG_QTNA_WIFI
	params->hs20_enable = hapd->conf->hs20;
	params->proxy_arp = hapd->conf->proxy_arp;
#endif /* CONFIG_QTNA_WIFI */
	...
	if ((hapd->conf->wpa_key_mgmt & WPA_KEY_MGMT_FT_PSK)
		...
		|| (hapd->conf->wpa_key_mgmt & WPA_KEY_MGMT_FT_SAE)
		|| (hapd->conf->wpa_key_mgmt & (WPA_KEY_MGMT_FT_PSK | WPA_KEY_MGMT_FT_SAE))) {
		params->mdid = *((u16 *)(&hapd->conf->mobility_domain[0]));
		params->ft_over_ds = hapd->conf->ft_over_ds;
	} else {
		params->mdid = 0;
		params->ft_over_ds = hapd->conf->ft_over_ds;
	}
