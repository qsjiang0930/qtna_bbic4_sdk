...
ifeq ($(BR2_PACKAGE_DHCP_QUERY_ONLY),y)
	toolchain/patch-kernel.sh $(DHCP_DIR) package/dhcp/ dhclient_query_only.patch
endif
	toolchain/patch-kernel.sh $(DHCP_DIR) package/dhcp/ wpa_notify_dhclient_getIP.patch
...
server_lib_dependancy:$(DHCP_DIR)/.configured
	$(MAKE) $(TARGET_CONFIGURE_OPTS) $(BVARS) -C $(DHCP_DIR)/dhcpctl

$(TARGET_DIR)/$(DHCP_SERVER_TARGET_BINARY): lib_dependancy server_lib_dependancy
