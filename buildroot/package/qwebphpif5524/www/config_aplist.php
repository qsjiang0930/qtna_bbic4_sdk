...
{
	confirm("This page is only for the Extender Mode.");
...
if (isset($_POST['action']))
{
	...
	{
		$local_mode = exec("get_qfdr_running_mode");
...
if($curr_ssid == "") $curr_ssid=exec("call_qcsapi_sockrpc --host $client_ip get_ssid wifi0");
?>
...
<div style="border:6px solid #9FACB7; width:800px; background-color:#fff;">
	<div class="righttop">5G Wi-Fi - ACCESS POINT LIST</div>
