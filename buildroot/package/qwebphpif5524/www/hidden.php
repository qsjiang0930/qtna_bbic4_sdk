...
function set_value()
{
	global $curr_hw_wps_pbc,$curr_mode,$curr_pp_name,$curr_pp_status,$curr_nonwps_pp_status,$curr_mspp_name,$curr_mspp_status,$curr_region,$file_region,$curr_scs_status,$curr_vsp_status,$curr_bf_status,$arr,$curr_coc_status,$interface_id;
	//set att pp status
