...
function set_value()
{
	...
	if ($_POST['action'] == 0)
	{
		if ($curr_mode == "0")
		{
			...
			if ($change_flag>0)
			{
				...
				exec("call_qcsapi_sockrpc --host $client_ip qwe qweaction wlan1 commit");
			}
		}
	}
	else if ($_POST['action'] == 2)
	{
		exec("call_qcsapi_sockrpc --host $client_ip qwe qweaction wlan1 wps pbc");
	...
	else if($_POST['action'] == 3)
	{
		...
		$tmp=exec("call_qcsapi_sockrpc --host $client_ip qwe qweaction wlan1 wps $curr_wpspin");
