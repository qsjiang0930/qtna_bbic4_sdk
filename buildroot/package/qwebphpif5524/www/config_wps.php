...
function get_value()
{
	global $curr_mode,$local_mode,$ssid0,$mac0,$arr_ssid,$arr_index,$sum_active_interface,$ssid1,$mac1,$ssid2,$mac2,$ssid3,$mac3,$ssid4,$mac4,$ssid5,$mac5,$ssid6,$mac6,$ssid7,$mac7,$curr_wpsstate0,$curr_wpsstate,$curr_wpspin,$curr_appin,$pre_check_bf_mf_for_wps,$interface_id;
	...
	session_start();
	$get_hs20_status = $_SESSION['hs20_status'];
	...
	{
		//Get WPS Pin
		if($local_mode == "Access point")
		{
			$curr_wpspin = trim(shell_exec("call_qcsapi get_wps_ap_pin wifi0"));
		}
		else if ($local_mode == "Station")
		{
...
function set_value()
{
	global $curr_mode,$local_mode,$ssid0,$mac0,$arr_ssid,$arr_index,$sum_active_interface,$ssid1,$mac1,$ssid2,$mac2,$ssid3,$mac3,$ssid4,$mac4,$ssid5,$mac5,$ssid6,$mac6,$ssid7,$mac7,$curr_wpsstate,$curr_wpspin,$curr_appin,$interface_id,$page_id;
	...
	if ($_POST['action'] == 0)
	{
		exec("qfdr_wps_proxy set_wps_configured_state $interface_id $new_wpsstate");
		if($new_wpsstate == "2")
		{
	...
	else if ($_POST['action'] == 2)
	{
		if($curr_mode == "Access point")
		{
			exec("qfdr_wps_proxy report_button_press $interface_id");
		}
		else if ($curr_mode == "Station")
		{
			exec("qfdr_wps_proxy report_button_press wifi0");
		}
	}
	else if($_POST['action'] == 3)
	{
		...
		if($local_mode == "Access point")
		{
			...
			if($tmp==$curr_wpspin)
			{
				exec("qfdr_wps_proxy report_pin $interface_id $curr_wpspin");
				sleep(1);
	...
	{
		$curr_appin=exec("qfdr_wps_proxy generate_ap_pin $interface_id");
		//$wps_session=2;
	}
}
...
<div class="container">
	...
	<div class="right">
		<div class="righttop">5G WI-FI - WPS</div>
		<div class="rightmain">
