...
$(SIGMA_DIR)/.unpacked: $(DL_DIR)/$(SIGMA_SOURCE)
	...
	patch -d $(SIGMA_DIR) -p1 < $(TOPDIR)/package/sigma/wfa/enlarge_cmd_buffer_to_8k.patch
...
sigma: $(SIGMA_DIR)/.unpacked
	...
	cp -f $(QNTN_SIGMA_DIR)/scripts/npu_cfg $(TARGET_DIR)/scripts/npu_cfg
	chmod +x $(TARGET_DIR)/scripts/npu_cfg
	cp -f $(QNTN_SIGMA_DIR)/scripts/npu_setup $(TARGET_DIR)/scripts/npu_setup
	chmod +x $(TARGET_DIR)/scripts/npu_setup
