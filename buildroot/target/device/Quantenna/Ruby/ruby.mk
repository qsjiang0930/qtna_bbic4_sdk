...
GCC_LIBDIR = ${gcc_top_dir}/lib/
GDBSERVER_SRC = ${gcc_top_dir}/bin/gdbserver
...
ruby_qtnenv:
	@cp -f $(RUBY_FS_PATCH_DIR)/set_qtnenv $(RUBY_FS_PATCH_DIR)/import_qtnenv $(TARGET_DIR)/bin
	@chmod 0755 $(TARGET_DIR)/bin/set_qtnenv $(TARGET_DIR)/bin/import_qtnenv
...
ruby-initd-files-y += qlink.d
endif

ruby-initd-files-$(BR2_PACKAGE_BOA)	+= S42boa
ruby-initd-files-$(BR2_PACKAGE_QCSAPI_SYSMON)	+= S94sysmon
