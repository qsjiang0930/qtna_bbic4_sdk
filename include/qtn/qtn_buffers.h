...
#define TOPAZ_HBM_SKB_ALLOCATOR			2
	...
	#define QTN_BUFS_WMAC_TX_LHOST_S	10
	...
	#define QTN_BUFS_WMAC_RX_RING_S		10
	#define QTN_BUFS_WMAC_TX_NON_LHOST_S	9
	#define QTN_BUFS_WMAC_TX_LHOST_S	11
#else
...
#define QTN_BUFS_WMAC_TX_LHOST		(1 << QTN_BUFS_WMAC_TX_LHOST_S)
...
#define QTN_BUFS_WMAC_TOTAL		(1 * (QTN_BUFS_WMAC_RX_RING + QTN_BUFS_WMAC_TX_NON_LHOST + QTN_BUFS_WMAC_TX_LHOST + QDRV_MAX_QUEUED_MGMT_FRAMES))
