...
#define TOPAZ_CONGEST_MAX_UNICAST_QCOUNT	(4)
...
struct topaz_congest_queue {
	...
	*/
	...
	/*
	 * {node,tid} is not congested, but a packet destined to it fails to be
	 * xmited and enqueued onto a new queue allocated for target {node,tid}.
	 */
	uint32_t cong_state;
