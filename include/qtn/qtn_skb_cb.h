...
struct qtn_skb_cb {
	...
	uint32_t	flags;
	uint64_t	pn;
	struct qtn_skb_cb_radio radio_info;
...
#define	M_TX_DONE_IMM_INT	0x1000	/* Immediately interrupt lhost when tx done */
#define M_VLAN_TAGGED		0x2000	/* skb belongs to some VLAN */
#define M_ORIG_OUTSIDE		0x4000	/* skb is not from local protocol stack */
#define M_ORIG_BR		0x8000	/* skb is sent from bridge interfaces */
#define M_NO_L2_LRN		0x00010000 /* MAC learning disabled */
#define M_IPFF			0x00020000 /* IP flood-forward */
#define M_HAS_RADIO_INFO	0x00040000 /* skb has meta radio info set */
#define M_L2_EXT_FILTER		0x00100000
};
