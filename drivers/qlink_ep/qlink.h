...
#define QLINK_PROTO_VER_MAJOR		19
...
/**
 * struct qlink_cmd_tid_cfg - data for QLINK_CMD_TID_CFG command
 *
 * @addr: peer MAC address
 * @tid: TID number
 * @data: variable list of STA/TID params
 */
struct qlink_cmd_tid_cfg {
	struct qlink_cmd chdr;
	u8 addr[ETH_ALEN];
	u8 tid;
	u8 rsvd[1];
...
enum qlink_tlv_id {
	...
	QTN_TLV_ID_AMPDU_LEN		= 0x0414,
	QTN_TLV_ID_AMSDU_LEN		= 0x0415,
