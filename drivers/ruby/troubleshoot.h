...
#define ARC_SRAM_SAFE_AREA_SIZE (CONFIG_ARC_MUC_STACK_SIZE - RUBY_CRUMBS_PRESERVED_SIZE)
#define ARC_SRAM_SAFE_AREA_BASE (CONFIG_ARC_MUC_STACK_INIT - ARC_SRAM_SAFE_AREA_SIZE)
#define ARC_SRAM_SAFE_AREA_END (CONFIG_ARC_MUC_STACK_INIT)
