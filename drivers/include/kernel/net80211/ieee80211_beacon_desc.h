...
struct ieee80211_beacon_param_t {
	uint8_t buf[BEACON_PARAM_SIZE];		/* linear buffer for the ie list */
...
#define IEEE80211_ELEMID_VENDOR_REPEATER	(IEEE80211_ELEMID_VENDOR << 8 | 0xC)
#define IEEE80211_ELEMID_VENDOR_RPE		(IEEE80211_ELEMID_VENDOR << 8 | 0xD)
#define IEEE80211_ELEMID_VENDOR_RP_INFO		(IEEE80211_ELEMID_VENDOR << 8 | 0xE)
