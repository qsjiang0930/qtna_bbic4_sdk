...
#ifdef QTN_RC_ENABLE_HDP
extern netdev_tx_t vmac_tx(void *pkt_handle, struct net_device *ndev, enum pkt_type pkt_type);
#else
extern netdev_tx_t vmac_tx(void *pkt_handle, struct net_device *ndev);
#endif
