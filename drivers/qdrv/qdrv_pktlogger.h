...
/* Should be in sync with enum pktlogger_stat_types */
enum qdrv_netdbg_rectype_e {
	QDRV_NETDEBUG_TYPE_STATS = 1,
	QDRV_NETDEBUG_TYPE_UNUSED_2 = 2,
	...
	QDRV_NETDEBUG_TYPE_NODE_RATE_STATS = 13,
	QDRV_NETDEBUG_TYPE_VISION = 14,
	QDRV_NETDEBUG_TYPE_UNUSED_15 = 15,
