...
#define RUBY_SYS_CTL_END_ADDR			(RUBY_SYS_CTL_BASE_ADDR + 0xFFF)
...
#define	RUBY_SYS_CTL_GPIO_IRQ_CLR		(RUBY_SYS_CTL_BASE_ADDR + 0xC8)
...
#define RUBY_M2L_IRQ_LO_PCIE_HOST	(6)
...
#define RUBY_QT3_BB_MIMO_BF_RX_DUMP_ANY		(1 << 4) /* Dump FFT for any */
#define RUBY_QT3_BB_MIMO_BF_RX_SW_LOCK		(1 << 9) /* Use this bit for SW locking */
...
/* WMAC0 debug select value */
#define QTN_WMAC0_DBG_SEL	0x5180

/* MAC debug select value */
#define RUBY_SYS_CTL_DBG_BUS_0	0x10
#define RUBY_SYS_CTL_DBG_BUS_1	0x11

#define RUBY_DBG_BUS_TIMER_CONT_Q3	0xF000
#define RUBY_DBG_BUS_TIMER_CONT_Q2	0x0F00
#define RUBY_DBG_BUS_TIMER_CONT_Q1	0x00F0
#define RUBY_DBG_BUS_TIMER_CONT_Q0	0x000F

/* TIMER Queue's transmitted frame */
#define RUBY_DBG_BUS_TIMER_Q3_FRM_SND	0x2000
#define RUBY_DBG_BUS_TIMER_Q2_FRM_SND	0x0200
#define RUBY_DBG_BUS_TIMER_Q1_FRM_SND	0x0020
#define RUBY_DBG_BUS_TIMER_Q0_FRM_SND	0x0002

/* Contention Queue's transmitted frame */
#define RUBY_DBG_BUS_CONT_Q3_FRM_SND	0xE000
#define RUBY_DBG_BUS_CONT_Q2_FRM_SND	0x0E00
#define RUBY_DBG_BUS_CONT_Q1_FRM_SND	0x00E0
#define RUBY_DBG_BUS_CONT_Q0_FRM_SND	0x000E

#define RUBY_DBG_BUS_TIMER_Q_BUSY	0xFFFF0000
#define RUBY_DBG_BUS_TIMER_Q_BUSY_S	16
