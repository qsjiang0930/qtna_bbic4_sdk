...
#define SPI_GENERIC_MAGIC	(0xffaa55)
...
static struct flash_info flash_data [] = {
	...
	{ "w25q20", 0xef4012, 4 * 1024, 64, SECTOR_ERASE_OP20, FREQ_MHZ(104), WINBOND },
	{ "w25q64", 0xef4017, 64 * 1024, 128, 0, FREQ_MHZ(80), WINBOND },
	{ "w25q128", 0xef4018, 64 * 1024, 256, 0, FREQ_MHZ(104), WINBOND },
	{ "w25q256jv", 0xef4019, 64 * 1024, 512, 0, FREQ_MHZ(104), WINBOND },
	...
	/* generic */
	{ "generic", SPI_GENERIC_MAGIC, 64 * 1024, 256, 0, FREQ_MHZ(62.5), GENERIC },
