...
ifeq ($(flash_size),64KB)
CFLAGS +=  -DFLASH_SIZE_64KB
endif
ifeq ($(flash_size),128KB)
CFLAGS +=  -DFLASH_SIZE_128KB
endif
ifeq ($(flash_size),256KB)
CFLAGS +=  -DFLASH_SIZE_256KB
endif
ifeq ($(flash_size),512KB)
CFLAGS +=  -DFLASH_SIZE_512KB
endif
ifeq ($(flash_size),1MB)
CFLAGS +=  -DFLASH_SIZE_1MB
endif
ifeq ($(flash_size),2MB)
CFLAGS +=  -DFLASH_SIZE_2MB
endif
ifeq ($(flash_size),4MB)
CFLAGS +=  -DFLASH_SIZE_4MB
endif
ifeq ($(flash_size),8MB)
CFLAGS +=  -DFLASH_SIZE_8MB
endif
ifeq ($(flash_size),16MB)
CFLAGS +=  -DFLASH_SIZE_16MB
endif
ifeq ($(flash_size),32MB)
CFLAGS +=  -DFLASH_SIZE_32MB
endif
ifeq ($(flash_size),64MB)
CFLAGS +=  -DFLASH_SIZE_64MB
endif
