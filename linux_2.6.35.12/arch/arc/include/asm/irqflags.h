...
#define local_irq_save(x) { x = _local_irq_save_level1(); }
#else
#define local_irq_save(x) { x = _local_irq_save_both(); }
#endif
#define local_irq_save_both(x)	{ x = _local_irq_save_both(); }

static inline long _local_irq_save_level1(void) {
...
static inline long _local_irq_save_both(void) {
    unsigned long temp, flags;
