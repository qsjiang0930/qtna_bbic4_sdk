...
/* FIXME: this is done to for make MMAP_CODE_SPC_START address as the same, and TASK_SIZE should be aliquot by 3 */
#if TOPAZ_SUPPORT_256MB_DDR && TOPAZ_MMAP_UNIFIED
#define VMALLOC_SIZE		(208*1024*1024)
#else
