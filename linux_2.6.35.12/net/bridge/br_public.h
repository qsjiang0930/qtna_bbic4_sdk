...
#define BR_SET_MAC_ADDR		0x00000001
	...
	u32				hash_elasticity;
	u32				hash_max;
#define BR_NEVER_FLOOD_REPORT		0
...
#define BR_MAX_IP_FLOOD_ENTRIES		256
	__be32 ip_flood_list[BR_MAX_IP_FLOOD_ENTRIES];
	int ip_flood_list_count;

	struct net_bridge_port *l2_ext_filter_port;
};
...
extern unsigned char (*br_fdb_delete_by_sub_port_hook)(struct net_bridge *br,
						       ...
						       port_id sub_port);
extern unsigned char (*br_fdb_update_by_sub_port_hook)(struct net_bridge *br,
						       const struct net_bridge_port *p,
