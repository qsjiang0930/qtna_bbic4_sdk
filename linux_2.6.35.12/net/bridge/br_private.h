...
extern unsigned char br_fdb_delete_by_sub_port(struct net_bridge *br,
				      ...
				      port_id sub_port);
extern unsigned char br_fdb_update_by_sub_port(struct net_bridge *br,
				      const struct net_bridge_port *p,
...
extern void br_forward(const struct net_bridge_port *to, __u32 dest_port,
...
extern void br_mdb_delete_by_sub_port(struct net_bridge *br, const struct net_bridge_port *port,
					port_id sub_port);
extern void br_mdb_update_by_sub_port(struct net_bridge *br, const struct net_bridge_port *port,
					port_id sub_port, port_id new_sub_port);
