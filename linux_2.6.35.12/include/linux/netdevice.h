...
#define QTN_FLAG_L2_EXT_FILTER		0x10000000
#define QTN_FLAG_WIFI_L2_EXT_FILTER	(QTN_FLAG_WIFI_DEVICE | QTN_FLAG_L2_EXT_FILTER)
...
#define QTN_FLAG_IS_L2_EXT_FILTER(_flag_) \
	(((_flag_) & QTN_FLAG_WIFI_L2_EXT_FILTER) == QTN_FLAG_WIFI_L2_EXT_FILTER)
	u32 qtn_flags;
};
